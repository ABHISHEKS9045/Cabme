class VehicleCategoryModel {
  ...
  VehicleCategoryModel(
      {this.success, this.error, this.message, this.vehicleData});
...
class VehicleData {
  ...
  dynamic minimumDeliveryCharges;
  dynamic minimumDeliveryChargesWithin;
  ...
  VehicleData.fromJson(Map<String, dynamic> json) {
    ...
    minimumDeliveryChargesWithin = json['minimum_delivery_charges_within'];
  }
